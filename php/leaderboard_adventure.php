...
<main>
    ...
    <div>
        ...
        <br>
        <h4 class="align-center">TOP PLAYER OF ADVENTURE MODE</h4>
        </div>

        <?php
        include("connexion_db.php");
        $requete = "SELECT username,adventure_lvl FROM user ORDER BY adventure_lvl DESC, time_trial ASC, username ASC limit 100";
